...
for (var i = 2; i < nodeArgs.length; i++) {
  ...
  address = address + " " + nodeArgs[i];   //concatinates every argument that is passed on the terminal
...
geocoder.geocode(address, function (err, data) {
  ...
  console.log(JSON.stringify(data, null, 2));  //pretifies the object into a string
